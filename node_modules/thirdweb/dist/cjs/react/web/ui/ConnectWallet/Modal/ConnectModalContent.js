...
const ConnectModalContent = (props) => {
    ...
    const walletList = ((0, jsx_runtime_1.jsx)(WalletSelector_js_1.WalletSelector, { title: props.meta.title || props.connectLocale.defaultModalTitle, wallets: props.wallets, onGetStarted: () => {
