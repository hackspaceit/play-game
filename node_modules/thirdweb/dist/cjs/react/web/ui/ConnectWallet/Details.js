...
const ConnectedWalletDetails = (props) => {
    ...
    const { ensAvatarQuery, addressOrENS, balanceQuery } = useWalletInfo(client, props.detailsButton?.displayBalanceToken);
    function closeModal() {
        setRootEl(null);
    }
    function openModal() {
        setRootEl((0, jsx_runtime_1.jsx)(DetailsModal, { client: client, locale: locale, detailsModal: props.detailsModal, theme: props.theme, supportedTokens: props.supportedTokens, closeModal: closeModal, onDisconnect: props.onDisconnect, chains: props.chains, displayBalanceToken: props.detailsButton?.displayBalanceToken }));
    }
...
function DetailsModal(props) {
    ...
    const { ensAvatarQuery, addressOrENS, balanceQuery } = useWalletInfo(client, props.displayBalanceToken);
    const activeWallet = (0, useActiveWallet_js_1.useActiveWallet)();
    ...
    let content = ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "lg", flex: "column", center: "x", children: [ensAvatarQuery.data ? ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: ensAvatarQuery.data, width: index_js_1.iconSize.xxl, height: index_js_1.iconSize.xxl, style: {
                        ...
                        gap: index_js_1.spacing.xs,
                            ...
                            gap: "1px",
                                    ...
                                    fontSize: index_js_1.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(CoinsIcon_js_1.CoinsIcon, { size: index_js_1.iconSize.md }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: "View Funds" })] }), (0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { onClick: () => {
                                ...
                                ((chainQuery.data?.faucets && chainQuery.data.faucets.length > 0) ||
                                    chainQuery.data?.chainId === LocalhostChainId) && ((0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuLink, { href: chainQuery.data?.faucets ? chainQuery.data.faucets[0] : "#", target: "_blank", as: "a", style: {
                                    textDecoration: "none",
                                    color: "inherit",
...
function useWalletInfo(client, displayBalanceToken) {
    const walletChain = (0, useActiveWalletChain_js_1.useActiveWalletChain)();
