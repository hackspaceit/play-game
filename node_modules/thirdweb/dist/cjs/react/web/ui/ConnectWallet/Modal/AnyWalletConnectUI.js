...
function AnyWalletConnectUI(props) {
    ...
    const localeFnQuery = (0, react_query_1.useQuery)({
        ...
        queryFn: async () => {
            return (0, getInjectedWalletLocale_js_1.getInjectedWalletLocale)(props.localeId);
        },
