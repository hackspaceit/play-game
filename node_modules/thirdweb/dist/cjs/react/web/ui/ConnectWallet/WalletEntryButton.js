...
function WalletEntryButton(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(exports.WalletButton, { type: "button", onClick: selectWallet, "data-active": screen && typeof screen === "object" && screen.id === walletId, children: [(0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { id: walletId, size: index_js_1.iconSize.xl, client: props.client }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "xxs", expand: true, children: [walletName ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", weight: 600, children: walletName })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: "100px", height: index_js_1.fontSize.md })), isRecommended && ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", children: props.connectLocale.recommended })), !isRecommended && isInstalled && ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", children: props.connectLocale.installed }))] })] }));
}
exports.WalletButton = (0, elements_js_1.StyledButton)((_) => {
