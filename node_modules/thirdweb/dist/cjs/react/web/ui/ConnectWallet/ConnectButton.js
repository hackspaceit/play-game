...
function ConnectButtonInner(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(Details_js_1.ConnectedWalletDetails, { theme: theme, detailsButton: props.detailsButton, detailsModal: props.detailsModal, supportedTokens: supportedTokens, onDisconnect: (info) => {
            // logout on explicit disconnect!
            if (siweAuth.requiresAuth) {
                siweAuth.doLogout();
            }
            props.onDisconnect?.(info);
        }, chains: props?.chains || [], chain: props.chain, switchButton: props.switchButton, client: props.client, connectLocale: locale }));
}
