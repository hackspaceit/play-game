...
const statusMeta_js_1 = require("../tx-history/statusMeta.js");
...
function FiatSteps(props) {
    ...
    const onRampChainMetaQuery = (0, useChainQuery_js_1.useChainQuery)(onRampChain);
    const toChainMetaQuery = (0, useChainQuery_js_1.useChainQuery)(toChain);
    const destinationChainMetaQuery = (0, useChainQuery_js_1.useChainQuery)(destinationChain);
    const onRampTokenInfo = ((0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", size: "sm", children: [(0, formatNumber_js_1.formatNumber)(Number(onRampTokenAmount), 4), " ", (0, jsx_runtime_1.jsx)(TokenSymbol_js_1.TokenSymbol, { token: onRampToken, chain: onRampChain, size: "sm", inline: true })] }) }));
    ...
    const onRampChainInfo = ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", children: onRampChainMetaQuery.data?.name }));
    const partialSuccessToTokenInfo = props.status?.status === "CRYPTO_SWAP_FALLBACK" &&
        props.status.destination ? ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "secondaryText", size: "sm", inline: true, style: {
                ...
                }, children: [(0, formatNumber_js_1.formatNumber)(Number(toTokenAmount), 4), " ", (0, jsx_runtime_1.jsx)(TokenSymbol_js_1.TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "secondaryText" })] }), " ", (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "danger", size: "sm", inline: true, children: [(0, formatNumber_js_1.formatNumber)(Number(props.status.destination.amount), 4), " ", (0, jsx_runtime_1.jsx)(TokenSymbol_js_1.TokenSymbol, { token: {
    ...
    const toTokenInfo = partialSuccessToTokenInfo || ((0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", size: "sm", children: [(0, formatNumber_js_1.formatNumber)(Number(toTokenAmount), 4), " ", (0, jsx_runtime_1.jsx)(TokenSymbol_js_1.TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true })] }));
    const partialSuccessToChainInfo = props.status?.status === "CRYPTO_SWAP_FALLBACK" &&
        ...
        props.status.destination.token.chainId !==
            props.status.quote.toToken.chainId ? ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", inline: true, style: {
                    textDecoration: "line-through",
                }, children: toChainMetaQuery.data?.name }), " ", (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", inline: true, children: destinationChainMetaQuery.data?.name })] })) : null;
    const toTokehChainInfo = partialSuccessToChainInfo || ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", children: toChainMetaQuery.data?.name }));
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { p: "lg", children: [(0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: "Buy", onBack: props.onBack }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsx)(PaymentStep, { title: (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", size: "md", children: ["Get", " ", (0, jsx_runtime_1.jsx)(TokenSymbol_js_1.TokenSymbol, { token: onRampToken, chain: onRampChain, size: "md", inline: true }), " ", "with ", props.partialQuote.fromCurrencySymbol] }), step: 1, from: {
                    icon: fiatIcon,
                    primaryText: ((0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", size: "sm", children: [(0, formatNumber_js_1.formatNumber)(Number(fromCurrencyAmount), 4), " ", fromCurrencySymbol] })),
                }, to: {
                    icon: onRampTokenIcon,
                    primaryText: onRampTokenInfo,
                    secondaryText: onRampChainInfo,
                }, state: getStep1State(), explorer: onRampChainMetaQuery.data?.explorers?.[0]?.url && onRampTxHash
                    ? {
                ...
                }, state: getStep2State(), explorer: toChainMetaQuery.data?.explorers?.[0]?.url && toTokenTxHash
                    ? {
                        label: "View on Explorer",
