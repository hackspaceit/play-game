...
const TokenInfoRow_js_1 = require("../tx-history/TokenInfoRow.js");
...
function OnRampTxDetailsTable(props) {
    const onRampChainQuery = (0, useChainQuery_js_1.useChainQuery)((0, utils_js_1.getCachedChain)(props.token.chainId));
