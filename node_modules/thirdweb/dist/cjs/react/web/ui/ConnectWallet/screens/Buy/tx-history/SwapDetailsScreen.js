...
function SwapTxDetailsTable(props) {
    ...
    const fromChainQuery = (0, useChainQuery_js_1.useChainQuery)((0, utils_js_1.getCachedChain)(fromChainId));
    const toChainQuery = (0, useChainQuery_js_1.useChainQuery)((0, utils_js_1.getCachedChain)(toChainId));
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { children: [isPartialSuccess && gotToken ? (
            ...
            (0, jsx_runtime_1.jsx)(TokenInfoRow_js_1.TokenInfoRow, { chainId: toToken.chainId, client: client, label: "Receive", tokenAmount: toToken.amount, tokenSymbol: toToken.symbol || "", tokenAddress: toToken.address })), lineSpacer, (0, jsx_runtime_1.jsx)(TokenInfoRow_js_1.TokenInfoRow, { chainId: fromToken.chainId, client: client, label: "Pay", tokenAmount: fromToken.amount, tokenSymbol: fromToken.symbol || "", tokenAddress: fromToken.address }), lineSpacer, (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", center: "y", style: {
                    justifyContent: "space-between",
                            ...
                            justifyContent: "space-between",
                        }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { children: "Status" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", gap: "xs", center: "y", children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: statusMeta.color, children: statusMeta.status }) })] })] })), lineSpacer, fromChainQuery.data?.explorers?.[0]?.url && sourceTxHash && ((0, jsx_runtime_1.jsxs)(buttons_js_1.ButtonLink, { fullWidth: true, variant: "outline", href: `${fromChainQuery.data.explorers[0].url}/tx/${sourceTxHash}`, target: "_blank", gap: "xs", style: {
                    fontSize: index_js_1.fontSize.sm,
                    padding: index_js_1.spacing.sm,
                }, children: ["View on ", fromChainQuery.data.name, " Explorer", (0, jsx_runtime_1.jsx)(react_icons_1.ExternalLinkIcon, { width: index_js_1.iconSize.sm, height: index_js_1.iconSize.sm })] })), destinationTxHash &&
                sourceTxHash !== destinationTxHash &&
                toChainQuery.data?.explorers?.[0]?.url && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" }), (0, jsx_runtime_1.jsxs)(buttons_js_1.ButtonLink, { fullWidth: true, variant: "outline", href: `${toChainQuery.data.explorers[0].url}/tx/${destinationTxHash}`, target: "_blank", gap: "xs", style: {
                            fontSize: index_js_1.fontSize.sm,
                            padding: index_js_1.spacing.sm,
                        }, children: ["View on ", toChainQuery.data.name, " Explorer", (0, jsx_runtime_1.jsx)(react_icons_1.ExternalLinkIcon, { width: index_js_1.iconSize.sm, height: index_js_1.iconSize.sm })] })] }))] }));
}
