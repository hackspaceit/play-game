...
function TokenInfoRow(props) {
    ...
    const chainQuery = (0, useChainQuery_js_1.useChainQuery)(chainObj);
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", style: {
            justifyContent: "space-between",
        }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { children: props.label }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "xxs", style: {
                    alignItems: "flex-end",
                                ...
                                }, client: props.client }), (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", children: [(0, formatNumber_js_1.formatNumber)(Number(props.tokenAmount), 4), " ", props.tokenSymbol] })] }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", children: chainQuery.data?.name })] })] }));
}
