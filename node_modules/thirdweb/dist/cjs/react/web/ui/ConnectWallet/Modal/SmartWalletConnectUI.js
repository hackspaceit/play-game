...
function SmartConnectUI(props) {
    ...
    if (!keyConnected) {
        return ((0, jsx_runtime_1.jsx)(AnyWalletConnectUI_js_1.AnyWalletConnectUI, { wallet: props.personalWallet, done: () => {
            ...
            }, onBack: props.onBack, setModalVisibility: props.setModalVisibility, chain: props.chain, chains: props.chains, client: props.client, meta: props.meta, size: props.size, localeId: props.localeId, walletConnect: props.walletConnect, connectLocale: props.connectLocale }));
    }
    return ((0, jsx_runtime_1.jsx)(SmartWalletConnecting, { done: props.done, personalWallet: props.personalWallet, accountAbstraction: props.accountAbstraction, onBack: props.onBack, personalWalletInfo: personalWalletInfo.data, localeId: props.localeId, size: props.size, client: props.client }));
}
function SmartWalletConnecting(props) {
    ...
    (0, react_1.useEffect)(() => {
        (0, getSmartWalletLocale_js_1.getSmartWalletLocale)(props.localeId).then(setLocale);
    }, [props.localeId]);
