...
const ChainName = (props) => {
    ...
    if (chainQuery.data) {
        return ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: props.size, children: props.short
                ? shorterChainName(chainQuery.data.name)
                : chainQuery.data.name }));
    }
    return (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: "50px", height: index_js_1.fontSize[props.size] });
};
