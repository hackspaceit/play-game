...
const storage_js_1 = require("../../wallets/shared/storage.js");
        ...
        async function fetchImage() {
            ...
            if (activeEOAId === "inApp" &&
                ...
                switch (lastAuthProvider) {
                    case "google":
                        image = socialLogins_js_1.googleIconUri;
                        break;
                    case "apple":
                        image = socialLogins_js_1.appleIconUri;
                        break;
                    case "facebook":
                        image = socialLogins_js_1.facebookIconUri;
                        break;
                    case "phone":
                        image = dataUris_js_1.phoneIcon;
                        break;
                    case "email":
                        image = dataUris_js_1.emailIcon;
                        break;
                    case "passkey":
                        image = dataUris_js_1.passkeyIcon;
                        break;
                }
            }
            else {
...
function WalletImageQuery(props) {
    ...
    if (walletImage.isFetched && !walletImage.data) {
        return ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { client: props.client, src: dataUris_js_1.genericWalletIcon, width: props.size, height: props.size }));
    }
