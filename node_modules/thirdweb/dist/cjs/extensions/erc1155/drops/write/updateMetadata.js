...
const getBaseURICount_js_1 = require("../../../erc721/__generated__/IBatchMintMetadata/read/getBaseURICount.js");
const updateBatchBaseURI_js_1 = require("../../__generated__/DropERC1155/write/updateBatchBaseURI.js");
/**
 * @internal
 */
async function getUpdateMetadataParams(options) {
    ...
    const [{ getBatchIdAtIndex }, { getNFT }] = await Promise.all([
        Promise.resolve().then(() => require("../../__generated__/BatchMintMetadata/read/getBatchIdAtIndex.js")),
    ...
    const currentMetadatas = await Promise.all(range.map((id) => getNFT({ contract, tokenId: id })));
