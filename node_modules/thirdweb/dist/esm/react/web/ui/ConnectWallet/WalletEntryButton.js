...
export function WalletEntryButton(props) {
    ...
    return (_jsxs(WalletButton, { type: "button", onClick: selectWallet, "data-active": screen && typeof screen === "object" && screen.id === walletId, children: [_jsx(WalletImage, { id: walletId, size: iconSize.xl, client: props.client }), _jsxs(Container, { flex: "column", gap: "xxs", expand: true, children: [walletName ? (_jsx(Text, { color: "primaryText", weight: 600, children: walletName })) : (_jsx(Skeleton, { width: "100px", height: fontSize.md })), isRecommended && (_jsx(Text, { size: "sm", children: props.connectLocale.recommended })), !isRecommended && isInstalled && (_jsx(Text, { size: "sm", children: props.connectLocale.installed }))] })] }));
}
