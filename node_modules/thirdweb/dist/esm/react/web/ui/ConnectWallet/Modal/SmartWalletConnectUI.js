...
export function SmartConnectUI(props) {
    ...
    return (_jsx(SmartWalletConnecting, { done: props.done, personalWallet: props.personalWallet, accountAbstraction: props.accountAbstraction, onBack: props.onBack, personalWalletInfo: personalWalletInfo.data, localeId: props.localeId, size: props.size, client: props.client }));
}
