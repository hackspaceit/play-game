...
export function FiatSteps(props) {
    ...
    const onRampTokenInfo = (_jsx("div", { children: _jsxs(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(onRampTokenAmount), 4), " ", _jsx(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "sm", inline: true })] }) }));
    ...
    const onRampChainInfo = (_jsx(Text, { size: "xs", children: onRampChainMetaQuery.data?.name }));
    const partialSuccessToTokenInfo = props.status?.status === "CRYPTO_SWAP_FALLBACK" &&
        props.status.destination ? (_jsxs("div", { children: [_jsxs(Text, { color: "secondaryText", size: "sm", inline: true, style: {
                ...
                }, children: [formatNumber(Number(toTokenAmount), 4), " ", _jsx(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "secondaryText" })] }), " ", _jsxs(Text, { color: "danger", size: "sm", inline: true, children: [formatNumber(Number(props.status.destination.amount), 4), " ", _jsx(TokenSymbol, { token: {
    ...
    const toTokenInfo = partialSuccessToTokenInfo || (_jsxs(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(toTokenAmount), 4), " ", _jsx(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true })] }));
    const partialSuccessToChainInfo = props.status?.status === "CRYPTO_SWAP_FALLBACK" &&
        ...
        props.status.destination.token.chainId !==
            props.status.quote.toToken.chainId ? (_jsxs("div", { children: [_jsx(Text, { size: "xs", inline: true, style: {
                    textDecoration: "line-through",
                }, children: toChainMetaQuery.data?.name }), " ", _jsx(Text, { size: "xs", inline: true, children: destinationChainMetaQuery.data?.name })] })) : null;
    const toTokehChainInfo = partialSuccessToChainInfo || (_jsx(Text, { size: "xs", children: toChainMetaQuery.data?.name }));
    ...
    return (_jsxs(Container, { p: "lg", children: [_jsx(ModalHeader, { title: "Buy", onBack: props.onBack }), _jsx(Spacer, { y: "lg" }), _jsx(PaymentStep, { title: _jsxs(Text, { color: "primaryText", size: "md", children: ["Get", " ", _jsx(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "md", inline: true }), " ", "with ", props.partialQuote.fromCurrencySymbol] }), step: 1, from: {
                    icon: fiatIcon,
                    primaryText: (_jsxs(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(fromCurrencyAmount), 4), " ", fromCurrencySymbol] })),
                }, to: {
