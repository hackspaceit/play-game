    ...
    return (_jsxs(Container, { animate: "fadein", style: {
            minHeight: "300px",
                    ...
                    maxHeight: "450px",
                                    ...
                                    }, children: [_jsx(ChainIcon, { chainIcon: chainQuery.data?.icon, size: iconSize.lg, client: props.client }), chainQuery.data ? (_jsxs(Text, { color: "primaryText", size: "sm", children: [" ", chainQuery.data.name] })) : (_jsx(Skeleton, { height: fontSize.md })), _jsx(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
                                                marginLeft: "auto",
